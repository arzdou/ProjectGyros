...
;BlastoiseFrontpic:   INCBIN "gfx/pokemon/swampert/front.animated.2bpp.lz" ; +
...
;BeedrillFrontpic:    INCBIN "gfx/pokemon/torterra/front.animated.2bpp.lz" ; +
...
;PoliwrathFrontpic:   INCBIN "gfx/pokemon/delphox/front.animated.2bpp.lz" ; +
...
;WartortleFrontpic:   INCBIN "gfx/pokemon/marshtomp/front.animated.2bpp.lz" ; +
...
;PoliwhirlFrontpic:   INCBIN "gfx/pokemon/braixen/front.animated.2bpp.lz" ; +
...
;ChikoritaFrontpic:   INCBIN "gfx/pokemon/bibarel/front.animated.2bpp.lz" ; +
;BibarelFrontpic:   INCBIN "gfx/pokemon/chikorita/front.animated.2bpp.lz" ; +
...
; Moved data below to 'Pics 19' section
...
;BeedrillBackpic:     INCBIN "gfx/pokemon/torterra/back.2bpp.lz" ; +
...
;PoliwagFrontpic:     INCBIN "gfx/pokemon/fennekin/front.animated.2bpp.lz" ; +
...
;PoliwrathBackpic:    INCBIN "gfx/pokemon/delphox/back.2bpp.lz" ; +
...
;BlastoiseBackpic:    INCBIN "gfx/pokemon/swampert/back.2bpp.lz" ; +
...
;WartortleBackpic:    INCBIN "gfx/pokemon/marshtomp/back.2bpp.lz" ; +
...
;PoliwhirlBackpic:    INCBIN "gfx/pokemon/braixen/back.2bpp.lz" ; +
...
;KakunaFrontpic:      INCBIN "gfx/pokemon/grotle/front.animated.2bpp.lz" ; +
...
;WeedleFrontpic:      INCBIN "gfx/pokemon/turtwig/front.animated.2bpp.lz" ; +
...
;ChikoritaBackpic:    INCBIN "gfx/pokemon/bibarel/back.2bpp.lz" ; +
;BibarelBackpic:    INCBIN "gfx/pokemon/chikorita/back.2bpp.lz" ; +
...
;KakunaBackpic:       INCBIN "gfx/pokemon/grotle/back.2bpp.lz" ; +
...
;WeedleBackpic:       INCBIN "gfx/pokemon/turtwig/back.2bpp.lz" ; +
...
;PoliwagBackpic:      INCBIN "gfx/pokemon/fennekin/back.2bpp.lz" ; +
...
; These didn't fit in 'Pics 9' section
MeowthFrontpic:      INCBIN "gfx/pokemon/meowth/front.animated.2bpp.lz"
Porygon2Frontpic:    INCBIN "gfx/pokemon/porygon2/front.animated.2bpp.lz"
SandshrewFrontpic:   INCBIN "gfx/pokemon/sandshrew/front.animated.2bpp.lz"
NidoranFFrontpic:    INCBIN "gfx/pokemon/nidoran_f/front.animated.2bpp.lz"
