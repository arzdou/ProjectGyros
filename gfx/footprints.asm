...
INCBIN "gfx/footprints/bibarel.1bpp",  footprint_top ; +
...
INCBIN "gfx/footprints/fletchinder.1bpp",   footprint_top ; +
...
INCBIN "gfx/footprints/fletchinder.1bpp",   footprint_bottom ; +
