...
; entries correspond to deco constants
	...
	decoration DECO_DOLL,    FENNEKIN,        SET_UP_DOLL,       EVENT_DECO_POLIWAG_DOLL,            SPRITE_FENNEKIN
	...
	decoration DECO_DOLL,    TURTWIG,         SET_UP_DOLL,       EVENT_DECO_WEEDLE_DOLL,             SPRITE_TURTWIG
