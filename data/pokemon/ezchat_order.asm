...
.a:        db EKANS, ARBOK, SEAKING, ARIADOS, SKIDDO, UNOWN, -1 ; +
...
.o:        db GOGOAT, FURRET, OCTILLERY, PRIMEAPE, SENTRET, STANTLER, SPEAROW, FEAROW, OMASTAR, OMANYTE, -1 ; +
;.o:        db FERALIGATR, FURRET, OCTILLERY, PRIMEAPE, SENTRET, STANTLER, SPEAROW, FEAROW, OMASTAR, OMANYTE, -1
.ka_ga:    db GROWLITHE, MACHAMP, DRAGONITE, PINSIR, SNORLAX, KABUTO, KABUTOPS, HITMONTOP, MARSHTOMP, SWAMPERT, FARFETCH_D, CUBONE, MAROWAK, KANGASKHAN, -1 ; + ; +
;.ka_ga:    db GROWLITHE, MACHAMP, DRAGONITE, PINSIR, SNORLAX, KABUTO, KABUTOPS, HITMONTOP, MARSHTOMP, BLASTOISE, FARFETCH_D, CUBONE, MAROWAK, KANGASKHAN, -1 ; +
;.ka_ga:    db GROWLITHE, MACHAMP, DRAGONITE, PINSIR, SNORLAX, KABUTO, KABUTOPS, HITMONTOP, WARTORTLE, SWAMPERT, FARFETCH_D, CUBONE, MAROWAK, KANGASKHAN, -1 ; +
...
.ko_go:    db MAGIKARP, MAGNEMITE, GASTLY, HAUNTER, MACHOKE, GROTLE, PSYDUCK, PHANPY, RATTATA, GOLDUCK, GOLBAT, GOLEM, GRAVELER, VENONAT, -1 ; +
...
.ni:       db NIDOKING, NIDOQUEEN, NIDORAN_M, NIDORAN_F, NIDORINA, NIDORINO, MEOWTH, SNEASEL, BRAIXEN, POLITOED, DELPHOX, FENNEKIN, -1 ; + ; + ; +
;.ni:       db NIDOKING, NIDOQUEEN, NIDORAN_M, NIDORAN_F, NIDORINA, NIDORINO, MEOWTH, SNEASEL, BRAIXEN, POLITOED, POLIWRATH, FENNEKIN, -1 ; + ; +
;.ni:       db NIDOKING, NIDOQUEEN, NIDORAN_M, NIDORAN_F, NIDORINA, NIDORINO, MEOWTH, SNEASEL, POLIWHIRL, POLITOED, DELPHOX, FENNEKIN, -1 ; + ; +
;;.ni:       db NIDOKING, NIDOQUEEN, NIDORAN_M, NIDORAN_F, NIDORINA, NIDORINO, MEOWTH, SNEASEL, POLIWHIRL, POLITOED, POLIWRATH, FENNEKIN, -1 ; +
;.ni:       db NIDOKING, NIDOQUEEN, NIDORAN_M, NIDORAN_F, NIDORINA, NIDORINO, MEOWTH, SNEASEL, BRAIXEN, POLITOED, DELPHOX, POLIWAG, -1 ; + ; +
;;.ni:       db NIDOKING, NIDOQUEEN, NIDORAN_M, NIDORAN_F, NIDORINA, NIDORINO, MEOWTH, SNEASEL, BRAIXEN, POLITOED, POLIWRATH, POLIWAG, -1 ; +
;;.ni:       db NIDOKING, NIDOQUEEN, NIDORAN_M, NIDORAN_F, NIDORINA, NIDORINO, MEOWTH, SNEASEL, POLIWHIRL, POLITOED, DELPHOX, POLIWAG, -1 ; +
...
.hi_bi_pi: db CLEFFA, TURTWIG, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, PICHU, CLEFAIRY, CHARMANDER, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, VOLTORB, -1 ; +
...
.he_be_pe: db FLETCHLING, GRIMER, MUK, HERACROSS, HOUNDOOM, PERSIAN, LICKITUNG, -1 ; +
;.he_be_pe: db BAYLEEF, GRIMER, MUK, HERACROSS, HOUNDOOM, PERSIAN, LICKITUNG, -1
.ho_bo_po: db HO_OH, MUNCHLAX, PIDGEY, PONYTA, SKIPLOOM, PORYGON, PORYGON2, -1 ; +
...
.me:       db FLETCHINDER, DITTO, TENTACOOL, MAREEP, -1 ; +
...
.ro:       db VULPIX, -1
.wa:       db JUMPLUFF, TALONFLAME, MACHOP ;, -1 ; +
